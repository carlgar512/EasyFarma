...
export class Usuario {
  ...
  constructor(
    ...
    tipoUsuario: TipoUsuario = TipoUsuario.Regular // ✅ POR DEFECTO REGULAR
  ) {
    this.dni = dni;
    this.email = email;
  ...
  static fromFirestore(uid: string, data: any): Usuario {
    const user = new Usuario(
      ...
      data.tipoUsuario as TipoUsuario
    );
  ...
  public getTipoUsuario(): TipoUsuario {
  ...
  public setTipoUsuario(tipo: TipoUsuario): void {
